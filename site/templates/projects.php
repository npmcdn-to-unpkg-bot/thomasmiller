                    ...
                    <div class="container-screen">
                      <div class="screen monitor">
                        <figure class="screen-image">
                          <img src="<?php echo $project->image()->url() ?>" alt="<?php echo $project->title() ?>">
                          <div class="image">
                            <img src="<?php echo $project->image()->url() ?>" alt="<?php echo $project->title() ?>">
                          </div>
                          <figcaption>
                            <h6><?php echo $project->urlname() ?></h6>
                          </figcaption>
                          <a href="<?php echo $project->theurl() ?>" class="monitor-link" target="_blank"></a>
                        </figure>
                        <div class="base">
      ...
      <div class="container">
        ...
        <div class="other-projects">
          <div class="row">
            ...
            <div class="col-xs-12">
            <?php $otherprojectCounter = 1; ?>
            <?php foreach($page->children()->visible() as $project): ?>
                <?php if ($project->featured() != '1'){?>
                  <div class="other-project">
                    <div class="other-project-bg-image" style="background-image: url(<?php if($image = $project->image()): ?><?php echo $image->url() ?><?php endif ?>);">
                      <a href="<?php echo $project->theurl() ?>" target="_blank"><?php echo $project->urlname() ?></a>
                    </div>
                  </div>
                <?php $otherprojectCounter++; ?>
              <?php } ?>
            <?php endforeach ?> 
            </div>
          </div>
