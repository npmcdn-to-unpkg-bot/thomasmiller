...
$(function(){
    $("#code-title").typed({
      strings: [
      "<h3>If your business is not on the Internet, then your business will be out of business. – Bill Gates</h3> ^2000",
      "^1200 <h3>Websites promote you 24/7: No employee will do that. – Paul Cookson</h3> ^2000",
      "^1200 <h3>If you think math is hard try web design. – Trish Parr</h3> ^2000",
      "^1200 <h3>Be curious. Read widely. Try new things. What people call intelligence just boils down to curiosity. – Aaron Swartz</h3> ^2000",      
      "^1200 <h3>Never Gonna Give You Up – Rick Astley</h3> ^2000"
      ],
      startDelay: 2000,
      typeSpeed: 0,
      backSpeed: 0.5,
...
$(function() {
    $('.portfolio .project .monitor-link').hover(function(){
      $(this).parent().toggleClass("monitor-hovered");
    });
});
// =====================================================
// Top animations
